...
| Date     | Time    | Room     |
|----------|---------|----------|
| 2 May    | 9 - 12  | WZB B 002 |
| 16 May   | 9 - 2   | WZB B 002 |
| 30 May   | 9 - 2   | WZB B 002 |
| 13 June  | 9 - 2   | WZB B 002 |
| 27 June  | 9 - 2   | WZB B 002 |

plus off cycle times scheduled off cycle

# Student survey


Please take a minute to complete this [short survey](https://cloud.wzb.eu/apps/forms/s/A2AsJyH2oEMXbfSijj9NZEAp)
...
* [Research design form](https://github.com/macartan/writing_seminar/tree/main) in `git` files

* For a sample project structure see [sample project](https://github.com/macartan/writing_seminar/tree/main/sample_project) in  `git`
...
The assumption is that you do not need to do original data collection in this time frame but you have an idea and you do need to do analysis and writing.

We will have four 5 hour group sessions plus off-biweekly individual sessions in alternative weeks.
