...
header-includes: |
  \usepackage{fancyhdr}  % Package for custom page numbering
  \usepackage{lipsum}    % Dummy text for testing (remove in final)
...
you can dedicate this to someone, or give a shout out to friends and family here!
